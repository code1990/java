...
public class MathUtil {
    ...
    public static double getLowBullInfo(double[] x) {
        return getAvg(x) - 1.8 * getStandardeviation(x);
    }

    public static double getMidBullInfo(double[] x) {
        return getAvg(x);
    }

    public static double getHighBullInfo(double[] x) {
        return getAvg(x) + 2.2 * getStandardeviation(x);
    }
}
