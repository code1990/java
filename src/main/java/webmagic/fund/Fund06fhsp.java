 ...
 */
public class Fund06fhsp  implements PageProcessor,Runnable {

    private Site site = Site.me().setRetryTimes(5).setSleepTime(1000).setTimeOut(10000);
    static String path = "C:\\Users\\xiala\\Desktop\\123\\fhsp.txt";
    static String target = "C:\\Users\\xiala\\Desktop\\123\\fhsp123.txt";
    ...
    public void process(Page page) {
        ...
        String url = page.getUrl().toString().replace("http://quotes.money.163.com/fund/jjfh_005911","");
...
//            url="http://quotes.money.163.com/fund/jjfh_005911.html";
            Spider.create(new Fund06fhsp()).addUrl(url).thread(5).run();
        }
...
//            str = str.replace("http://fund.eastmoney.com/","http://quotes.money.163.com/fund/jjfh_");
//            sb.append(str+"\n");
//            System.out.println(str);
//        }
//        TxtUtil.writeTxt("C:\\Users\\xiala\\Desktop\\123\\fhsp.txt",sb.toString());
//    }
}